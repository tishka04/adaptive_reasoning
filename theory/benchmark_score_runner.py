...
def _compact_condition(
    ...
    *,
    ...
    metric_names = (
        ...
        "frontier_context_actuator_demotions",
        "frontier_context_actuator_demotion_blocks",
        "causal_schema_exported",
        "causal_schema_terminal_chains",
        "causal_schema_probe_selections",
        "causal_schema_effect_confirmations",
        "causal_schema_chain_advances",
        "causal_schema_terminal_backcredits",
        "causal_schema_promotions",
        "causal_schema_demotions",
