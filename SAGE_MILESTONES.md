...
| SAGE.11b - Pilot + compact world model | Audit anti-shortcut no-go; petite recollecte relationnelle pre-enregistree; modele non entraine | `theory/sage11/relational_features.py`, `theory/sage11/relational_dataset.py`, `theory/sage11/relational_pilot_collection.py`, `theory/sage11/relational_effect_pilot.py`, `reports/SAGE11_RELATIONAL_PILOT_PROTOCOL.md`, `reports/SAGE11_ANTI_SHORTCUT_AUDIT_RESULT.md` | Audit v2: changed -0.1026, shuffle +0.0180, signatures jeu 99.17%. Remplacement gele avant collecte: 10,027 rows source-train (1,000/jeu sauf lp85=27), schema 52 relations checksum `84f044dd08f3240f968a6ba1bf528896eab00eb39066dcce95d0f87e9a9193f7`, gates changed +0.10/shuffle +0.10/apport relations +0.05/robustesse 9/11; training GPU bloque |
