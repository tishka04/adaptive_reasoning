...
class OnlineTemporalGoalComposer:
    ...
    def __init__(
        ...
        *,
        ...
        self._mediated_exploitation_starts_total = 0
    ...
    def select_step(
        ...
        *,
        ...
        preferred_exploitation_edge_key: str = "",
        ...
        for plan in self.plans():
            ...
            mediated_exploitation = bool(
                str(preferred_exploitation_edge_key)
                and plan.causal_edge_key
                == str(preferred_exploitation_edge_key)
            )
            mediated_reservation = bool(
                mediated_exploitation
                or mediated_discrimination
                or mediated_replication
            )
            if (
        ...
        if (
            ...
            self._mediated_exploitation_starts_total += 1
        elif (
            str(preferred_discrimination_edge_key)
            and plan.causal_edge_key
            == str(preferred_discrimination_edge_key)
    ...
    def summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "mediated_exploitation_preparation_starts": (
                self._mediated_exploitation_starts_total
            ),
